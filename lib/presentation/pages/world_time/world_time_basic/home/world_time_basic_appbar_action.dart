...
import '../city_search/world_time_basic_city_search_page.dart';

class WorldTimeBasicAppBarActions extends StatelessWidget {
  final TimeController controller;
  final VoidCallback onAfterAddOrDateChange;

  const WorldTimeBasicAppBarActions({
    super.key,
        ...
        children: [
          if (hasSelection)
            IconButton(
              ...
              onPressed: () {
                // xoá selection trong controller
                controller.selectedStartUtc.value = null;
                controller.selectedEndUtc.value = null;
                controller.selectedDate.value = null;

                // trigger reset vị trí thanh chọn
          ...
          IconButton(
            ...
            onPressed: () async {
              await Get.to(() => WorldTimeBasicCitySearchPage());
              onAfterAddOrDateChange();
            },
          ),
        ],
